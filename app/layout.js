            ...
            <div class="overlap">
              ...
              <div class="group">
                <div class="div">
                  ...
                  <a href="/Dashboard" class="text-wrapper">Dashboard</a>
                </div>
                <div class="group-2">
                  <div class="frame-wrapper">
                    <div class="frame">
                      <img class="img-2" src="https://c.animaapp.com/DC1Sd5sj/img/iconly-6.svg" />
                      <a href="/Business" class="text-wrapper-2">Businesses</a>
                      <img
                ...
                <div class="group-4">
                  <div class="group-5">
                    <div class="frame-4">
                      ...
                      <a href="/News" class="text-wrapper-5">News</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="group-8">
                  <div class="group-9">
                    <div class="frame-4">
                      ...
                      <a href="/Oppurtunities" class="text-wrapper-5">Opportunities</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="group-10">
                  <div class="frame-5">
                    ...
                    <a href="/Rewwardss" class="text-wrapper-6">Rewards</a>
                  </div>
                </div>
                ...
                <a href="/Uevent" class="text-wrapper-7">Upcoming Events</a>
                <a href="/Events" class="text-wrapper-8">Event Booked</a>
              </div>

              <div class="rectangle-2"></div>
              <div class="group-12">
                <div class="group-13">
                  <div className='text-wrapper-9'>Search anything...</div>
              ...
              <div class="group-14">
                ...
                <button><img class="vuesax-linear-2" src="https://c.animaapp.com/DC1Sd5sj/img/vuesax-linear-messages-3-2.svg" /></button>
              </div>
